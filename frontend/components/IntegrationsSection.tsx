    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Connect your Google account to export OKRs as a presentation. If you signed in with Google, your account may already be connected. After connecting, use the &quot;Google Slides&quot; button on the Dashboard.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Button
